...
INSERT INTO "new_Transaction" ("amount", "createdAt", "credits", "id", "stripeCheckoutId", "stripeCustomerId", "userEmail") SELECT "amount", "createdAt", "credits", "id", "stripeCheckoutId", "stripeCustomerId", "userEmail" FROM "Transaction";
